...
//        String chromeDriverPath = "/usr/bin/chromedriver";
        ...
        //Spider.create(new LagouProcessor()).addUrl("https://www.lagou.com/jobs/list_java/p-city_235?&cl=false&fromSearch=true&labelWords=&suginput=").setDownloader(new LagouSeleniuDownloader(chromeDriverPath)).thread(1).run();
    }
