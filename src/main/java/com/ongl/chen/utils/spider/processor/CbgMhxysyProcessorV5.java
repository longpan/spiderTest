...
*/
@Component
public class CbgMhxysyProcessorV5 implements PageProcessor {
...
//        String chromeDriverPath = "/usr/bin/chromedriver";
       // Spider.create(new CbgMhxysyProcessor()).addUrl("https://my.cbg.163.com/cgi/mweb/pl?view_loc=equip_list&from=kingkong&tfid=f_kingkong&refer_sn=01933EA6-4505-655E-BD4F-92DF5539C411").setDownloader(new CbgSeleniuDownloader(chromeDriverPath)).thread(1).run();
        Spider.create(new CbgMhxysyProcessorV5()).addUrl("https://my.cbg.163.com/cgi/mweb/?refer_sn=019344AA-8DFB-4F14-C5C9-DC35F0348BE8").setDownloader(new CbgSeleniuDownloaderV3(chromeDriverPath)).thread(1).run();

    }



    public void start(AppConfigFromPost appConfigFromPost, CbgItemService cbgItemService) {
...
//        String chromeDriverPath = "/usr/bin/chromedriver";
        CbgSeleniuDownloaderV5 downloaderV5 = new CbgSeleniuDownloaderV5(chromeDriverPath, appConfigFromPost, cbgItemService);

        Spider.create(new CbgMhxysyProcessorV5()).addUrl("https://my.cbg.163.com/cgi/mweb/?refer_sn=019344AA-8DFB-4F14-C5C9-DC35F0348BE8").setDownloader(downloaderV5).thread(1).run();
