...
//        String chromeDriverPath = "/usr/bin/chromedriver";
    ...
    public void start(AppConfigFromPostForCbg appConfigFromPost, MhEquipItemService mhEquipItemService) {
        ...
        Spider.create(new CbgMhxyEquipProcessor(mhEquipItemService, appConfigFromPost)).addUrl(appConfigFromPost.getDetailUrl()).setDownloader(seleniuDownloader).thread(1).run();
